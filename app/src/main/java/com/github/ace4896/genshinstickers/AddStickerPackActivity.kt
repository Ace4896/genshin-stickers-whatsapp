...
import com.github.ace4896.genshinstickers.BaseActivity.MessageDialogFragment.Companion.newInstance
import com.github.ace4896.genshinstickers.WhitelistCheck.isPackageInstalled
import com.github.ace4896.genshinstickers.WhitelistCheck.isStickerPackWhitelistedInWhatsAppConsumer
import com.github.ace4896.genshinstickers.WhitelistCheck.isStickerPackWhitelistedInWhatsAppSmb
import com.github.ace4896.genshinstickers.WhitelistCheck.isWhatsAppConsumerAppInstalled
import com.github.ace4896.genshinstickers.WhitelistCheck.isWhatsAppSmbAppInstalled
...
abstract class AddStickerPackActivity : BaseActivity() {
    ...
    private fun onAddPackActivityResult(result: ActivityResult) {
    ...
    class StickerPackNotAddedMessageFragment : DialogFragment() {
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            val dialogBuilder = AlertDialog.Builder(
                ...
                .setNeutralButton(R.string.add_pack_fail_prompt_update_play_link) { _: DialogInterface?, _: Int -> launchWhatsAppPlayStorePage() }
