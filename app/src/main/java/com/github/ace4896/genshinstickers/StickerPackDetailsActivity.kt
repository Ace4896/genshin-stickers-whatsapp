...
class StickerPackDetailsActivity : AddStickerPackActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val expandedStickerView =
            findViewById<SimpleDraweeView>(R.id.sticker_details_expanded_sticker)
        val addButton: View = findViewById(R.id.add_to_whatsapp_button)!!
        this.addButton = addButton
        alreadyAddedText = findViewById(R.id.already_added_text)
        layoutManager = GridLayoutManager(this, 1)
        val recyclerView: RecyclerView = findViewById(R.id.sticker_list)!!
        ...
        if (supportActionBar != null) {
            ...
            supportActionBar!!.title =
                if (showUpButton) getResources().getString(R.string.title_activity_sticker_pack_details_multiple_pack) else getResources().getQuantityString(
    ...
    private fun updateAddUI(isWhitelisted: Boolean) {
        if (isWhitelisted) {
            ...
            findViewById<View>(R.id.sticker_pack_details_tap_to_preview).visibility = View.GONE
        } else {
            addButton!!.visibility = View.VISIBLE
            alreadyAddedText!!.visibility = View.GONE
            findViewById<View>(R.id.sticker_pack_details_tap_to_preview).visibility =
                View.VISIBLE
        }
    }
